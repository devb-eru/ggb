...
| [아트 버티컬 슬라이스 의뢰서](REQ-ART-2026-0001_버티컬슬라이스.md) | 배경·오브젝트·퍼즐·UI·대표 캐릭터 샘플 |
...
| `BATCH-DEMO02` | 공개 데모 잔여 범위 | 범위 예약, VS01 실측 뒤 상세화 |
| `BATCH-FULL03` | 본편 전용 범위 | 범위 예약, 데모 제작률 뒤 상세화 |
