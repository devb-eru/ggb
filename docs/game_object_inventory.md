...
| 공간 구조·이동·생활 소품군 | §3 | 28 제작 묶음 |
| 튜토리얼·조사·읽기 자료 | §4 | 26 제작 묶음 |
| 메인 퍼즐 하위 부품 | §5 | 14 패널·60 하위 부품군 |
| 캐릭터 소품·부착부 | §6 | 13 캐릭터 소품·8 관계 작업 키트, 합계 21 제작 묶음 |
...
| `PRDOBJ_PARLOR_CLOCK_HOUSING` | 대응접실 기준 괘종시계 | `M1_PARLOR` | P2 시각 예고·B3-A 탁본 | 기본·진동 예고·탁본·시간망 노출 |
...
| --- | --- | --- | --- |
| `PRDOBJ_P2_CLEANING_CLOTH` | 창문 닦는 천 | P2·대응접실 | 획득·선택·젖은 면/마른 면·오염·반납 |
| `PRDOBJ_P2_COARSE_BRUSH` | 창틀용 거친 솔 | P2·대응접실 | 조사·먼지 번짐 오답·복구·반납 |
| `PRDOBJ_P2_WATER_BOTTLE` | 작은 유리 물병 | P2·대응접실 | 선택 사용·물기 생성·사용 불가·리셋 복원 |
