...
| `04_전체이벤트리스트_상태표.md` | D6·E1·F2·F3 사건 행, 필수 knowledge, 고유 조사 Set, 상태 플래그 | 완료 |
...
| `17_상태변수_이벤트ID_Godot데이터구조.md` | 세부 노드, E1·F3 unique Set, F2 knowledge, F3 저장·잠금, schema 10 | 완료 |
