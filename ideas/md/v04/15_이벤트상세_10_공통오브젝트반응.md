...
| `17_상태변수_이벤트ID_Godot데이터구조.md` | ObjectReaction, resolver, canonical registry, schema 12 | P1 | 완료 |
...
| `GGB-ERR-2026-0010` | canonical 오브젝트 ID·반응 저장 계약이 문서 15에 고립 | 04·05·17 레지스트리와 schema 12 동기화 | VERIFIED |

신규 리소스 구현은 문서 17의 schema 12와 문서 05의 location 배치를 기준으로 시작한다. 이후 ID를 추가할 때는 문서 04·05·15·17을 같은 변경 단위로 갱신한다.
