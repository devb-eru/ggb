...
flowchart TB
    ...
    REL_B_MARA2 --> B2
    B2 --> B2_ATTENTION
    B2_ATTENTION -- "조용히 조사" --> J1
    B2_ATTENTION -- "주의도 상승·숨음" --> B2_HIDE
    B2_ATTENTION -- "주의도 상승·남음" --> B2_EDGAR_ENTRY
    B2_ATTENTION -- "벽감 미발견·발각" --> B2_CAUGHT
    B2_HIDE -- "에드가 점검 뒤 퇴장" --> J1
    B2_EDGAR_ENTRY --> B2_CAUGHT
