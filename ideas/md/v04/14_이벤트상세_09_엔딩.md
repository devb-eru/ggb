...
| --- | --- | --- | --- |
| 자유 | `OBJ_REALITY_HAND` | 손가락·관절·실제 통증 확인 | EDR_BODY_CHECK 하위 Set |
| 자유 | `OBJ_REALITY_BREATH_MONITOR` | 자동 호흡과 자기 호흡의 분리 확인 | EDR_BODY_CHECK 하위 Set |
| 자유 | `OBJ_REALITY_RESTRAINT` | 비상 손잡이·혼자 풀 수 있는 구조 확인 | EDR_BODY_CHECK 하위 Set |
