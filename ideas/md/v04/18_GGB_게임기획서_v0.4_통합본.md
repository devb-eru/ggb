...
| EDC | `final_decision`, `final_choice_relation` | 현실·잔류 중 하나를 최종 확정하고 이전 의향과의 관계만 분류 | 관계·기록에 따른 선택지 잠금 |
...
- 2026-07-19 정적 검사에서 H1, 코드 펜스, 상대 Markdown 링크가 통과했고, F3 잠금 시점·E1 4종/3종·F2 필수 지식 5종·F0-E/EDC 분리 계약을 수동 교차 확인했다. Mermaid는 텍스트 구조만 확인했으며 실제 렌더링은 후속 검증 대상이다.
